# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_gamepad_obsevations.ipynb.

# %% auto 0
__all__ = ['normalize_stick_event', 'normalize_trigger_event', 'process_stick_event', 'process_trigger_event',
           'process_button_event', 'record_gamepad_events', 'a_record_gamepad_events']

# %% ../nbs/04_gamepad_obsevations.ipynb 1
import time
import inputs
...
# %% ../nbs/04_gamepad_obsevations.ipynb 2
...
# %% ../nbs/04_gamepad_obsevations.ipynb 4
...
# %% ../nbs/04_gamepad_obsevations.ipynb 6
...
# %% ../nbs/04_gamepad_obsevations.ipynb 8
...
# %% ../nbs/04_gamepad_obsevations.ipynb 10
...
async def a_record_gamepad_events(duration, THRESHOLD = .05, verbose=False):
    return record_gamepad_events(duration, THRESHOLD, verbose)
